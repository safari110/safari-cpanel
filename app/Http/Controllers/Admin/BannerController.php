...
class BannerController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
           ...
           // 'zone_id' => 'required',
            'wilaya_id' => 'required_if:banner_type,wilaya_wise',
            'item_id' => 'required_if:banner_type,target_wise',
        ], [
           // 'zone_id.required' => translate('messages.select_a_zone'),
            'wilaya_id.required_if'=> translate('messages.Wilaya is required when banner type is Wilaya wise'),
            'item_id.required_if'=> translate('messages.target is required when banner type is target wise'),
        ]);
       ...
       // $banner->zone_id = $request->zone_id;
        ...
        $banner->data = ($request->banner_type == 'wilaya_wise')?$request->wilaya_id:$request->item_id;
        $banner->save();
        $data=[];
