...
class ProductController extends Controller
{
    ...
    public function food_or_restaurant_search(Request $request,$q){
    ...
    public function get_restaurant_products(Request $request,$id)
    {
        ...
        $products = ProductLogic::get_restaurant__products(restaurant_id: $id, type: $type,name:$key);
        $products = Helpers::product_data_formatting(data:$products,multi_data: true, trans:false, local:app()->getLocale());
        return response()->json($products, 200);
    }
    ...
    public function findNearbyTargets($lat, $long, $distance)
    {
       //efault max distance is 5 kilometers

        // Find nearby restaurants using Haversine formula
        $products = ProductLogic::getnearTargets($lat,$long, $distance);
        $products = Helpers::product_data_formatting(data:$products,multi_data: true, trans:false, local:app()->getLocale());
        return response()->json($products, 200);
    }
}
