                        ...
                        <div class="card-body">
                            ...
                            <div class="lang_form" id="default-form">
                                ...
                                <div>
                                    ...
                                    <textarea id="address" name="address[]" class="form-control h-70px" placeholder="{{ translate('messages.Ex :') }} {{ translate('good wilaya..... ') }}"  ></textarea>
                                </div>
                            </div>
                    ...
                    <div class="card shadow--card-2">
                       ...
                       <div class="card-body pb-0">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label class="input-label" for="l_name">
                                            {{ translate('messages.email') }}</label>
                                        <input id="l_name" type="text" name="l_name" class="form-control h--45px"
                                            placeholder="{{ translate('messages.Ex :') }} wilaya"
