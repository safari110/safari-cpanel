            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <span class="badge badge-soft-danger text-left">
                        This location setup is for your Main branch. Carefully set your Wilaya location and coverage area. If you want to ignore the coverage area then keep the input box empty.<br>
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{env('APP_MODE')!='demo'?route('vendor.business-settings.update-location'):'javascript:'}}" method="post"
                    ...
                    @csrf
                    @php($data=\App\CentralLogics\Helpers::get_restaurant_data())
                    <div class="row">
