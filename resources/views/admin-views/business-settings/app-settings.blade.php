...
@section('content')
    <div class="content container-fluid">
        ...
        @php
            ...
            'most_reviewed_targets','app_minimum_version_ios_deliveryman','app_url_ios_deliveryman'
        ];
        ...
        $most_reviewed_foods=$settings['most_reviewed_targets'] ?? null;
                    ...
                    <div class="col-md-6 col-sm-6 col-12">
                        <div class="form-group m-0">
                            ...
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 px-xl-4 form-control" >
                                <span class="pr-2">{{translate('messages.popular_targets')}}
                                      <span class="input-label-secondary text--title" data-toggle="tooltip"
                                        data-placement="right"
                                        data-original-title="{{ translate('If_enabled,_Popular_targets_will_be_available_on_the_User_App') }}">
                                            <i class="tio-info-outined"></i>
                                        </span>
                                    </span>
                                <input type="checkbox" class="toggle-switch-input"
                                onclick="toogleStatusModal(event,'popular_food','veg-on.png','veg-off.png','{{translate('Want_to_enable_the_Popular_targets_section!')}}','{{translate('Want_to_disable_the_Popular_targets_option?')}}',`<p>{{translate('If_enabled,_users_can_see_popular_targets_on_the_user_app.')}}</p>`,`<p>{{translate('If_disabled,_users_can _not_see_popular_targets_on_the_user_app.')}}</p>`)"
...
_                               {{$new_restaurant?'checked':''}}>
                    ...
                    <div class="col-md-6 col-sm-6 col-12">
                        <div class="form-group m-0">
                            <form action="{{route('admin.business-settings.toggle-settings',['most_reviewed_targets',$most_reviewed_foods?0:1, 'most_reviewed_targets'])}}" id="most_reviewed_targets_form" method="get">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 px-xl-4 form-control" >
                                <span class="pr-2 text-capitalize">{{translate('messages.most_reviewed_targets')}}
                                      <span class="input-label-secondary text--title" data-toggle="tooltip"
                                        data-placement="right"
                                        data-original-title="{{ translate('If_enabled,_the_Most_Reviewed_targets_will_be_available_on_the_User_App.') }}">
                                            <i class="tio-info-outined"></i>
                                        </span>
                                    </span>
                                <input type="checkbox" class="toggle-switch-input"  id="most_reviewed_targets"
                                onclick="toogleStatusModal(event,'most_reviewed_targets','veg-on.png','veg-off.png','{{translate('Want_to_enable_the_Most_Reviewed_targets_option?!')}}','{{translate('Want_to_disable_the_Most_Reviewed_targets_option?!')}}',`<p>{{translate('If_enabled,_users_can_see_the_most_reviewed_targets_on_the_user_app.')}}</p>`,`<p>{{translate('If_disabled,_users_can_not_see_the_most_reviewed_targets_on_the_user_app.')}}</p>`)"
                    ...
                    <div class="single-item-slider owl-carousel">
                        <div class="item">
                            <div class="mb-20">
                                ...
                                <ul>
                                    <li>
                                        {{ translate('This_app_version_defines_the_User_app_version_of_Safari.') }}
                                    </li>
                                    <li>
