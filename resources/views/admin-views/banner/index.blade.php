                                   ...
                                   {{-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="banner_type" id="banner_type" class="form-control" onchange="banner_type_change(this.value)">
                                            <option value="wilaya_wise">{{translate('messages.restaurant')}} {{translate('messages.wise')}}</option>
                                            <option value="item_wise">{{translate('messages.target')}} {{translate('messages.wise')}}</option>
                                        </select>
                                    </div>
                                    <div class="form-group" id="wilaya_wise">
                                        ...
                                        <select name="wilaya_id" class="js-data-example-ajax form-control"  title="Select Wilaya" >
                                    ...
                                    <div class="form-group" id="item_wise">
                                        ...
                                        <select name="item_id" id="choice_item" class="form-control js-select2-custom" title="{{translate('messages.select_target')}}" >
                                            <option selected disabled>{{ translate('Select') }}</option>
                                        </select>
                                    </div>
                                </div>
...
<script>
    $(document).on('ready', function () {
        var zone_id = [];
        var select_control = $('#banner_type, #wilaya_wise select, #item_wise select');
