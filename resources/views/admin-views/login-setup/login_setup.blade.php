        ...
        <div class="page-header d-flex flex-wrap align-items-center justify-content-between">
            <h1 class="page-header-title">
             ...
             <div class="text--primary-2 d-flex flex-wrap align-items-center" type="button" data-toggle="modal" data-target="#how-it-works">
                <strong class="mr-2">{{translate('How this Setting Works')}}</strong>
                <div class="blinkings">
                        ...
                        <div class="item">
                            <div class="mb-20">
                                <div class="text-center">
                                    ...
                                    <h5 class="modal-title">{{translate('What is login url ?')}}</h5>
                                </div>
                                <ul>
                                    <li>
                                        {{ translate('change the url for secure your admin panel.') }}
                                    </li>
                                    {{-- <li>
