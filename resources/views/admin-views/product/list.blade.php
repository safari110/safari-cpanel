...
@section('title', translate('Targets List'))
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-md-auto mb-md-0 mb-3 mr-auto">
                    <h1 class="page-header-title"> {{ translate('messages.target') }} {{ translate('messages.list') }}<span
                        ...
                        <table id="datatable"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="w-100px">{{ translate('messages.description') }}</th>
                                    <th class="w-100px">{{ translate('messages.category') }}</th>
                                    <th class="w-100px">{{ translate('messages.restaurant') }}</th>
