                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    {{-- <li class="nav-item">
                        <small class="nav-subtitle"
                            title="{{ translate('Promotion') }}  {{ translate('messages.management') }}">{{ translate('Promotions') }}
                    ...
                    {{-- @if (\App\CentralLogics\Helpers::module_permission_check('contact_message'))
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.contact.list') }}" title="{{ translate('Contact_messages') }}">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('restaurant'))
                        {{-- <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.cuisine.add') }}" title="{{ translate('messages.cuisine') }}">
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="navbar-item {{ Request::is('admin/restaurant/list') || Request::is('admin/restaurant/transcation/*') ? 'active' : '' }} {{ Request::is('admin/restaurant/view*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
...
{{-- 
                                <li
                                    class="navbar-item {{ Request::is('admin/restaurant/pending/list*') || Request::is('admin/restaurant/denied/list*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                            title="{{ translate('messages.targets') }} {{ translate('messages.section') }}">{{ translate('messages.targets') }}
                            {{ translate('messages.management') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('food'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/food*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('messages.targets') }}">
                                <i class="tio-city nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.targets') }}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
...
<!-- End Banner -->
                        ...
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('messages.Pages') }}">
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                title="{{ translate('messages.system') }} {{ translate('messages.settings') }}">{{ translate('messages.system') }}
                                {{ translate('messages.settings') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
