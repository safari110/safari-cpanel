...
Route::group(['namespace' => 'Api\V1', 'middleware'=>['localization','react']], function () {
    ...
    Route::group(['prefix' => 'products'], function () {
        ...
        Route::get('near-Targets/{lat}/{long}/{distance}', 'ProductController@findNearbyTargets');
        ...
        Route::get('restaurant-products/{id}', 'ProductController@get_restaurant_products');
        ...
        Route::get('food-or-restaurant-search/{query}', 'ProductController@food_or_restaurant_search');
        Route::get('recommended/most-reviewed', 'ProductController@recommended_most_reviewed');
    });

    Route::group(['prefix' => 'wilaya'], function () {
        Route::get('get-wilaya/{filter_data}', 'RestaurantController@get_restaurants');
    ...
    Route::group(['prefix' => 'categories'], function () {
        ...
        Route::get('products/{category_id}/{resto_id}/all', 'CategoryController@get_all_productsbycategoryresto');
